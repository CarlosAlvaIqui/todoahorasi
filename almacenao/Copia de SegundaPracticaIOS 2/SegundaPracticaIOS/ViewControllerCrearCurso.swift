...
class ViewControllerCrearCurso: UIViewController {
    ...
    @IBAction func agregar(_ sender: Any) {
        ...
        curso.nota1 = Int16(Int(txtNotanumero1.text!)!)
        curso.nota2 = Int16(Int(txtNotanumero2.text!)!)
        curso.nota3 = Int16(Int(txtNotanumero3.text!)!)
        curso.nota4 = Int16(Int(txtNotanumero4.text!)!)
        curso.promedio = Int16(Int(promedio_lab.text!)!)
